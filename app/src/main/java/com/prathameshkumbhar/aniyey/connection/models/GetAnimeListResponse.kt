...
@Parcelize
data class GetAnimeListResponse(
    @SerializedName("data")
    var `data`: List<Data?>?,
    ...
    data class Data(
        ...
        var members: Int?, // 1062062
        @SerializedName("popularity")
        var popularity: Int?, // 157
        ...
        data class Theme(
            ...
            var malId: Int?, // 38
            @SerializedName("name")
            var name: String?, // Military
            @SerializedName("type") 
            var type: String?, // anime
            @SerializedName("url")
            var url: String? // https://myanimelist.net/anime/genre/38/Military
        ) : Parcelable
